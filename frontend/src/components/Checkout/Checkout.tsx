...
function Checkout() {
    ...
    const [address,setAddress] = useState<Address>({first:"",second:"",phone:""})
    const [load,setLoad] = useState<Load>({tixLoad:false,addLoad:false})
    console.log(address)
    
    function submitForm(){
        
    }
    function changeAddress(name:string,value:string){
