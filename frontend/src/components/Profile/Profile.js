...
function Profile() {
    ...
    return  (!userData.bookings )? (<PageLoading />) : (
        ...
        <div id="profile">
            <div className='infoBook'>
                ...
                <div className="infoUser">
                    <div className='nameRow'>
                        <div className='checkpoint'>
                            ...
                            <input type="text" disabled={true}   placeholder={`${userData.firstName} ${userData.lastName}`} />
                        </div>
                        <div className='checkpoint'>
                            <label>Email</label>
                            <input type="text" disabled={true}  placeholder={userData.email} />
                        </div>
                    </div>
                    <div className='nameRow'>
                        <div className='checkpoint'>
                ...
                <div id="booking">
                  ...
                  {userData.bookings.map(({booking ,totalAmount})=> {
                  ...
                  return (<div className='userBooks'>
                                ...
                                <div className='colBoo'>
                                    <div className='movBoo'>
                                        <h3>{booking.seatsBooked.map((el,i)=>i==0? (el) : (`, ${el}`))}</h3>
                                        <h4>SEATS</h4>
                                    </div>
                                </div>
                                <div className='colBoo'>
